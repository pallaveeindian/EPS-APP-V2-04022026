...
export default function NewEnterpriseForm({ route, navigation }) {
  ...
  const getBeneficiaryKey = () => {
    ...
    // Fallback if no member_code is found
    console.log(
      " Drafts Disabled: Missing 'member_code' for this beneficiary.",
    );
    return null;
  };
  ...
  const ensureRecordedBeneficiary = async () => {
    if (!beneficiary) {
      throw new Error(
        'Beneficiary data missing. Cannot prepare beneficiary payload.',
      );
    }
    ...
    // IMPORTANT:
    // API CALL REMOVE KAR DIYA
    // Sirf payload return hoga
  ...
  const createEnterpriseTypeRecord = () => {
    ...
    const payload = {
      ...
      // EXAMPLE:
      // "Dairy,Poultry"
      // OR OBJECT/STRING DEPENDING ON YOUR ENCODER
      sub_category: dictString,
  ...
  //     //  ADD THIS
  //     console.log('=== NEW ENTERPRISE PAYLOAD ===');
  ...
  //     if (
  //       form.is_training_required === 'Yes' &&
  //       !Object.values(trainingReqSectors || {}).some(
  //         item => item?.selected,
  //       )
  //     ) {
  //       Alert.alert(
  ...
  //         Alert.alert(
  //           'Validation',
  //           'Please add at least one training detail.',
  //         );
  //         return;
  //       }
  ...
  //         if (
  //           !Object.values(row.sectors || {}).some(
  //             item => item?.selected,
  //           )
  //         ) {
  //           Alert.alert(
  ...
  //         Alert.alert(
  //           'Validation',
  //           'Please select infrastructure support type.',
  //         );
  //         return;
  //       }
  ...
  //     if (!signatureAsset?.uri) {
  //       Alert.alert(
  //         'Validation',
  //         'Please upload applicant signature.',
  //       );
  //       return;
  //     }
  ...
  //         ? beneficiary
  //         : recordedBenef &&
  //           Object.keys(recordedBenef).length > 0
  //           ? recordedBenef
  //           : {};
  ...
  //       if (form.nearest_skill_centre_known === 'Yes') {
  //         nearest_skill_centre =
  //           form.nearest_skill_centre_name || 'Yes';
  ...
  //       if (form.nearest_industry_known === 'Yes') {
  //         nearest_industry =
  //           form.nearest_industry_name || 'Yes';
  ...
  //           selectedBeneficiary?.member_code ??
  //           selectedBeneficiary?.lokos_code ??
  //           '',

  //         applicant_name:
  //           selectedBeneficiary?.applicant_name ??
  //           selectedBeneficiary?.member_name ??
  ...
  //           selectedBeneficiary?.beneficiary_age
  //         ),
  ...
  //         father_husband_name:
  //           selectedBeneficiary?.father_husband_name ??
  //           selectedBeneficiary?.father_husband ??
  //           selectedBeneficiary?.husband_name ??
  //           '',

  //         category:
  //           selectedBeneficiary?.category ??
  //           selectedBeneficiary?.social_category ??
  //           selectedBeneficiary?.caste_category ??
  //           '',

  //         pld_status:
  //           selectedBeneficiary?.pld_status ??
  //           selectedBeneficiary?.pld ??
  //           selectedBeneficiary?.pldStatus ??
  //           selectedBeneficiary?.is_pld ??
  //           selectedBeneficiary?.PLD ??
  //           'No',
  ...
  //           selectedBeneficiary?.education_name ??
  //           '',

  //         address:
  //           selectedBeneficiary?.address ??
  //           selectedBeneficiary?.full_address ??
  //           selectedBeneficiary?.village_name ??
  //           '',
  ...
  //         district_id: sanitizeId(
  //           selectedBeneficiary?.district_id?.id ??
  //           selectedBeneficiary?.district_id?.value ??
  //           selectedBeneficiary?.district_id ??
  //           selectedBeneficiary?.district?.id ??
  //           selectedBeneficiary?.district?.value ??
  //           selectedBeneficiary?.district ??
  //           selectedBeneficiary?.districtId ??
  //           selectedBeneficiary?.district_id_id
  //         ),
  ...
  //         block_id: sanitizeId(
  //           selectedBeneficiary?.block_id?.id ??
  //           selectedBeneficiary?.block_id?.value ??
  //           selectedBeneficiary?.block_id ??
  //           selectedBeneficiary?.block?.id ??
  //           selectedBeneficiary?.block?.value ??
  //           selectedBeneficiary?.block ??
  //           selectedBeneficiary?.blockId ??
  //           selectedBeneficiary?.block_id_id
  //         ),
  ...
  //         panchayat_id: sanitizeId(
  //           selectedBeneficiary?.panchayat_id?.id ??
  //           selectedBeneficiary?.panchayat_id?.value ??
  //           selectedBeneficiary?.panchayat_id ??
  //           selectedBeneficiary?.panchayat?.id ??
  //           selectedBeneficiary?.panchayat?.value ??
  //           selectedBeneficiary?.panchayat ??
  //           selectedBeneficiary?.panchayatId ??
  //           selectedBeneficiary?.panchayat_id_id
  //         ),
  ...
  //         village_id: sanitizeId(
  //           selectedBeneficiary?.village_id?.id ??
  //           selectedBeneficiary?.village_id?.value ??
  //           selectedBeneficiary?.village_id ??
  //           selectedBeneficiary?.village?.id ??
  //           selectedBeneficiary?.village?.value ??
  //           selectedBeneficiary?.village ??
  //           selectedBeneficiary?.villageId ??
  //           selectedBeneficiary?.village_id_id
  //         ),
  ...
  //           sub_category: Object.keys(
  //             value?.children || {},
  //           )
  //             .filter(
  //               child =>
  //                 value.children?.[child]?.selected,
  //             )
  //             .join(', '),
  ...
  //           fund.amount_repaid || '0',
  //         ),

  //         repayment_status:
  //           parseFloat(fund.amount_repaid || 0) >=
  //             parseFloat(fund.amount_received || 0)
  //             ? 'PAID'
  //             : parseFloat(fund.amount_repaid || 0) > 0
  //               ? 'PARTIALLY PAID'
  //               : 'NOT PAID',
  ...
  //       (row, index) => {
  //         const certKey = `cert_file_rec_${index}`;

  //         finalPayload.training_requests.push({
  //           form_type: 'rec',
  ...
  //           certificate_file_keys: row.certificateImage?.uri
  //             ? [certKey]
  //             : [],
  ...
  //     console.log(
  //       'recordedBenef =>',
  //       JSON.stringify(recordedBenef, null, 2),
  //     );
  //     console.log(
  //       '=== SELECTED BENEFICIARY ===',
  //       JSON.stringify(selectedBeneficiary, null, 2),
  //     );
  //     console.log(
  //       '=== FINAL PAYLOAD ===',
  //     );
  ...
  //         if (row.certificateImage?.uri) {
  //           formData.append(certKey, {
  //             uri: row.certificateImage.uri,

  //             type:
  //               row.certificateImage.type ||
  //               'image/jpeg',

  //             name:
  //               row.certificateImage.fileName ||
  //               `cert_${index}.jpg`,
  //           });
  //         }
  //       },
  ...
  //     // console.log(
  //     //   JSON.stringify(enterpriseRes, null, 2),
  //     // );
  ...
  //     const enterpriseRes =
  //       await gsApi.createNewEnterprise(formData);
  ...
  //     const responseData =
  //       enterpriseRes?.data || enterpriseRes;
  ...
  //     if (
  //       !form.prefered_location_choice ||
  //       (Array.isArray(form.prefered_location_choice) &&
  //         form.prefered_location_choice.length === 0)
  //     ) {
  //       Alert.alert(
  //         'Validation',
  //         'Please select a preferred location for starting the enterprise.',
  ...
  //     let nearestskillcentre = null;
  //     let skillcentreloc = null;
  //     let nearestindustry = null;
  ...
  //       ) {
  //         nearestindustry =
  //           form.nearest_industry_name || null;
  ...
  //       trainingReceivedRows.forEach(
  //         (row, index) => {
  //           const certKey = `certfile_rec_${index}`;
  ...
  //           .filter(
  //             k =>
  //               trainingReqSectors?.[k]
  //                 ?.selected,
  //           )
  //           .join(','),

  //         department: trainingReqDept,

  //         training_type:
  //           trainingReqType?.join(','),

  //         duration:
  //           trainingReqDuration || 0,
  ...
  //     const categoriesPayload = Object.entries(
  //       enterpriseTypeSelection || {},
  //     )
  //       .filter(
  //         ([_, value]) => value?.selected,
  ...
  //         father_husband_name:
  //           beneficiaryPayload?.father_husband ||
  //           '',
  //       },
  ...
  const handleSubmit = async () => {
    try {
      ...
      //   enterpriseTypePayload?.parent_category ||
      //   ''
      // )
      //   .split(',')
      //   .filter(Boolean)
      ...
      //     sub_category:
      //       enterpriseTypePayload?.sub_category ||
      //       '',
      //   }));
