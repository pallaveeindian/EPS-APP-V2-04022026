...
export default function ShopBasedProductSection({
  row,
  index,
  updateRow
}) {
...

  {
    ...
    children: [
      ...
      { en: 'Competitive Exam Book Store', hi: 'प्रतियोगी परीक्षा पुस्तक दुकान' },
...

  {
    ...
    children: [
      ...
      { en: 'Surgical & Medical Equipment Store', hi: 'सर्जिकल एवं मेडिकल उपकरण दुकान' },
 ...
 const SALES_AREA_OPTIONS = [
  ...
  { en: 'Word of Mouth / Door-to-Door Selling', hi: 'मौखिक प्रचार / घर-घर बिक्री' },
  { en: 'Selling in Local Markets (Haat/Bazaar)', hi: 'स्थानीय बाजार (हाट/बाजार) में बिक्री' },
  { en: 'Using SHG Networks for Promotion', hi: 'एसएचजी नेटवर्क के माध्यम से प्रचार' },
  { en: 'Display Boards or Posters Near Shop/Workplace', hi: 'दुकान/कार्यस्थल के पास बोर्ड या पोस्टर' },
  { en: 'Others', hi: 'अन्य' }
];
...
<LanguageToggle/></View>
      ...
      <View style={styles.fieldBlock}>
        ...
        {renderYesNo(
          row.has_shop_product,
          val => updateRow(index, { has_shop_product: val })
        )}
      </View>
  ...
  <Picker.Item
    ...
    value={cat.parent.en} // always store English in DB
  />
))}
  </Picker>
</View>
...
{row.shop_type && (
  <View style={styles.fieldBlock}>
    ...
    {SHOP_CATEGORIES
      .find(cat => cat.parent.en === row.shop_type)
      ?.children?.map(child =>
      ...
      />
          ...
          <View style={styles.fieldBlock}>
            ...
            <TextInput
              ...
              onChangeText={(v) =>
                updateRow(index, { inventory_source: v })
              }
              placeholder={
                language === 'hi'
                  ? 'उदाहरण: थोक बाजार'
    ...
    {row.media[typeKey].map((file, i) => (
      <View key={i} style={styles.imageWrapper}>
        ...
        <TouchableOpacity
          ...
          onPress={() => {
            const updated = row.media[typeKey].filter((_, idx) => idx !== i);
