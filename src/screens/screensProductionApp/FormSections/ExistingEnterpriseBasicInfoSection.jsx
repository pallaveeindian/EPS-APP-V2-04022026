...
//     const exists = selectedTree.find(row => row.parent?.en === parent.en);
//     let updated;
//     if (exists) {
//       updated = selectedTree.filter(row => row.parent?.en !== parent.en);
//     } else {
//       updated = [
//         ...selectedTree,
//         { parent, children: [], parentOtherText: '', childOtherText: {} },
//       ];
//     }
//     onChange(updated);
//   };
...
//     const existing = selectedTree.find(row => row.parent?.en === parent.en);
...
//       const has = children.some(c => c.en === child.en);

//       const newChildren = has
//         ? children.filter(c => c.en !== child.en)
//         : [...children, child];

//       updated = updated.map(row =>
//         row.parent?.en === parent.en ? { ...row, children: newChildren } : row,
//       );
//     }
...
//     !!selectedTree.find(row => row.parent?.en === parent.en);

//   const isChildSelected = (parent, child) => {
//     const row = selectedTree.find(r => r.parent?.en === parent.en);
//     return !!row && row.children?.some(c => c.en === child.en);
//   };

//   const updateParentOtherText = (parent, text) => {
//     const updated = selectedTree.map(row =>
//       row.parent?.en === parent.en ? { ...row, parentOtherText: text } : row,
//     );
//     onChange(updated);
//   };
...
//                           }
//                           value={
//                             (rowData.childOtherText &&
//                               rowData.childOtherText[child.en]) ||
//                             ''
//                           }
//                           onChangeText={text =>
//                             updateChildOtherText(group.parent, child, text)
//                           }
//                         />
//                       )}
//                   </View>
...
//             : 'What is the type of your Enterprise?'}
//         </Text>
//         <Text style={styles.helpText}>
//           {language === 'hi'
...
//             : 'What is your Enterprise Ownership type?'}
//         </Text>
//         <Text style={styles.helpText}>
//           {language === 'hi'
...
//         </Text>
//         <View
//           style={[styles.input, { paddingHorizontal: 0, paddingVertical: 0 }]}
//         >
//           <Picker
...
//             : 'Which year was your Enterprise established in?'}
//         </Text>
//         <Text style={styles.helpText}>
//           {language === 'hi'
...
//               (language === 'hi' ? 'वर्ष चुनें' : 'Select Year')}
//           </Text>
//         </TouchableOpacity>
...
//       <LicenseSelector
//         language={language}
//         licenses={existingForm.licenses || []}
//         setLicenses={rows => {
//           console.log('Selected Licenses:', rows); // <-- log selected licenses
//           update({ licenses: rows });
//         }}
//       />
...
//         ].map(opt => {
//           const selected =
//             Array.isArray(existingForm.owner_cadre) &&
//             existingForm.owner_cadre.includes(opt);
//           const optLabel = (() => {
//             if (language === 'hi') {
//               switch (opt) {
//                 case 'Lakhpati CRP':
//                   return 'लखपति CRP';
//                 case 'Krishi Ajeevika Sakhi':
//                   return 'कृषि आजीविका सखी';
//                 case 'Krishi Udyog Sakhi':
//                   return 'कृषि उद्योग सखी';
//                 case 'Mahila Kisan':
//                   return 'महिला किसान';
//                 case 'CRP- EP':
//                   return 'CRP- EP';
...
//                 case 'Bank Sakhi':
//                   return 'बैंक सखी';
//                 case 'Fnhw Swasth sakhi':
//                   return 'Fnhw स्वास्थ्य सखी';
//                 case 'THR/Dry ration worker':
//                   return 'THR/सूखा राशन कार्यकर्ता';
//                 case 'Samuh Sakhi':
//                   return 'समूह सखी';
//                 case 'MGNREGA MATE':
//                   return 'मनरेगा मेट';
...
//         <Text style={styles.helpText}>
//           {' '}
//           {language === 'hi' ? 'अपना पद चुनें' : 'Select your designation'}
//         </Text>
...
//   modalOverlay: {
//     flex: 1,
//     backgroundColor: 'rgyba(0,0,0,0.35)',
      ...
      <View style={styles.fieldBlock}>
        ...
        {['Divyang', 'Widow', 'Unmarried', 'Other'].map(opt => (
          <TouchableOpacity
            ...
            // issue of select-unselect solved for special cateogary
            onPress={() =>
              update({
                owner_special_category:
                  existingForm.owner_special_category === opt ? '' : opt,
                owner_special_category_other:
                  existingForm.owner_special_category === opt ? '' : existingForm.owner_special_category_other,
              })
            }
          >
            <View
